...
class Construct_Dataset(Dataset):
    ...
    def __load_annotations(self, anno_name):
        ...
        assert len(annotations) > 0, "No images found in {}".format(anno_name)
    ...
    def __parse_annotation(self, index):
        ...
        if self.img_RAM[index] is not None:
            ...
            # with rasterio.open(anno[0]) as r:
...
if __name__ == '__main__':
    ...
    train_dataset = Construct_Dataset(anno_file_name=cfg.PROJECT_PATH, img_size=cfg.TRAIN["TRAIN_IMG_SIZE"])
