...
def cut(img_name, img_dir,box_dir,img_cut_dir):
    ...
    shape_path = os.path.join(box_dir,'*.shp')
    shape_path = glob.glob(shape_path)[0]
...
def main_cut_img(img_path,box_path,tmp_path):    
    ...
    img_cut_dir = os.path.join(tmp_path,foder_name+'_cut')
...
if __name__=='__main__':
    folder_paths = '/home/nghipham/Desktop/Jupyter/data/DA/5_India/Hyderabad'
    img_path = '/home/nghipham/Desktop/Jupyter/data/DA/5_India/Hyderabad/T1/a'
    box_path = os.path.join(folder_paths, 'box')
    tmp_path = '/home/nghipham/Desktop/Jupyter/data/DA/5_India/Hyderabad/T1/a/tm'
