...
def predict(image_path, result_path, weight_path, model, input_size_green, dil):
# def predict(image_path, result_path, weight_path, dil=False):
    print("*Init green model")
    # model = models.att_unet((128, 128, 4), [128, 256, 512, 1024], n_labels=1, stack_num_down=2, stack_num_up=2, 
    ...
    #                     # print(current_x,':',current_x+y_pred.shape[0],current_y,':',current_y+y_pred.shape[1])
    ...
    # # version trc do cho sentinel2 la 0.7
    # img2[img2>0.85]=0
    # img2[img2!=0]=1
    ...
    #     dst.write(dilation.astype(np.uint8),1)
    # return dilation
