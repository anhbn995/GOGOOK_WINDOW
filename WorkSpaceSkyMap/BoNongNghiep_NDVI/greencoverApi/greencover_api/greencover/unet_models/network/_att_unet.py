...
from tensorflow.keras.layers import Input, concatenate, ReLU
...
from greencover.unet_models.libs.layer_base import decode_layer, CONV_stack, CONV_output, attention_gate
...
def att_unet_base(input_tensor, filter_num, stack_num_down=2, stack_num_up=2, 
                    activation='ReLU', atten_activation='ReLU', attention='add', 
                    output_activation='Sigmoid', batch_norm=False, 
                    pool=True, unpool=True, backbone=None, weights='imagenet', 
...
def att_unet(input_size, filter_num, n_labels, stack_num_down=2, stack_num_up=2, activation='ReLU', 
    ...
    # base
    X = att_unet_base(IN, filter_num, stack_num_down=stack_num_down, stack_num_up=stack_num_up,
                         activation=activation, atten_activation=atten_activation, attention=attention,
