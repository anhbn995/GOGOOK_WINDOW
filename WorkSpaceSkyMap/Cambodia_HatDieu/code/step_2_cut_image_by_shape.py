...
def cut(img_name, img_dir,box_dir,img_cut_dir):
    ...
    # shape_path = r"E:\WORK\Mongodia\Data\orkhon.shp"
    # shape_path = r"E:\WORK\Mongodia\box.shp"
    shape_path = r"E:\WORK\Mongodia\ThuDo_monggo\Box_to_same_size\box.shp"
...
def main_cut_img(img_path,box_path,out_dir):    
    ...
    img_cut_dir = os.path.join(out_dir,'img_cut')
...
if __name__ == "__main__":
    ...
    # out_path = str(param.out_dir)

    img_path = os.path.abspath(sys.argv[1])
    box_path = os.path.abspath(sys.argv[2])
