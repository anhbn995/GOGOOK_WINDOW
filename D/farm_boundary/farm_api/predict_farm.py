...
if __name__=="__main__":
    img_path = '/mnt/data/public/farm_uint16/mos_neighbor_8u.tif'
    out_path = '/mnt/data/public/farm_uint16/mos_neighbor_8u_predict.geojson'
    model_path = '/mnt/data/eof/model_farm_boundary/model_farm.h5'
    size = 480
    ...
    parser.add_argument('--size', help='foo help', default=size)
    parser.add_argument('--threshold_distance', help='foo help', default=threshold_distance)
    parser.add_argument('--threshold_connect', help='foo help', default=threshold_connect)
    ...
    predict_farm(model_farm, args.input_path, cache_path, args.size)
    raster_to_vector(cache_path, args.output_path, args.threshold_distance, args.threshold_connect)
