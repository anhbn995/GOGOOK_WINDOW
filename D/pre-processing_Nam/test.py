...
# Doc file video
cap = cv2.VideoCapture("/mnt/Nam/tmp_Nam/pre-processing/106681209-drone-thermal-night-vision-cam_H264HD1080.mov")
...
# with rasterio.open('/mnt/Nam/public/hanoi_sen2/sen2_05_12_2019_0 copy_mask.tif') as r:
#     data=r.read()
#     out_meta = r.meta
# data = remove_small_holes(data.astype(bool), area_threshold=50)
# data = remove_small_objects(data, min_size=15)

# with rasterio.open('/mnt/Nam/public/hanoi_sen2/result_HN/sen2_05_12_2019_0.tif', 'w', compress='lzw', **out_meta) as ras:
#     ras.write(data[np.newaxis,...])
